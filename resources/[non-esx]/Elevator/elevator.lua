...
function Holograms()
		...
		while true do
			...
			Draw3DText( -2361.00, 3249.20, 32.50  -1.400, "Presiona la flecha hacia arriba para subir", 1, 0.1, 0.1)
		...
		if GetDistanceBetweenCoords( -2361.00, 3249.20, 92.00, GetEntityCoords(GetPlayerPed(-1))) < 1.0 then
			...
			Draw3DText( -2361.00, 3249.20, 92.50  -1.400, "Presiona la flecha hacia abajo para bajar", 1, 0.09, 0.09)

        end	
        
        if GetDistanceBetweenCoords( 136.19, -761.00, 45.75, GetEntityCoords(GetPlayerPed(-1))) < 1.0 then

			Draw3DText( 136.19, -761.00, 45.50  -1.400, "Presiona la flecha hacia arriba para subir", 1, 0.09, 0.09)

        end	
        
        if GetDistanceBetweenCoords( 136.19, -761.00, 234.15, GetEntityCoords(GetPlayerPed(-1))) < 1.0 then

			Draw3DText( 136.19, -761.00, 234.15 -1.400, "Presiona la flecha hacia arriba para subir", 1, 0.09, 0.09)

        end	

        if GetDistanceBetweenCoords( 136.19, -761.00, 234.15, GetEntityCoords(GetPlayerPed(-1))) < 1.0 then

			Draw3DText( 136.19, -761.00, 234.15 -1.600, "Presiona la flecha hacia abajo para bajar", 1, 0.09, 0.09)

        end	
        
        if GetDistanceBetweenCoords(136.19, -761.00, 242.15, GetEntityCoords(GetPlayerPed(-1))) < 1.0 then

			Draw3DText(136.19, -761.00, 242.15 -1.400 , "Presiona la flecha hacia abajo para bajar", 1, 0.09, 0.09)

        end	
        
        if GetDistanceBetweenCoords(246.43, -1372.55, 24.54, GetEntityCoords(GetPlayerPed(-1))) < 1.0 then

			Draw3DText(246.43, -1372.55, 24.54 -1.400 , "Presiona la flecha hacia arriba para subir", 1, 0.09, 0.09)

        end	
       
        if GetDistanceBetweenCoords(248.68, -1369.94, 29.65, GetEntityCoords(GetPlayerPed(-1))) < 1.0 then

			Draw3DText(248.68, -1369.94, 29.65 -1.400 , "Presiona la flecha hacia abajo para bajar", 1, 0.09, 0.09)

        end	

        if GetDistanceBetweenCoords(3540.75, 3676.64, 21.00, GetEntityCoords(GetPlayerPed(-1))) < 1.0 then

			Draw3DText(3540.75, 3676.64, 21.00 -1.400 , "Presiona la flecha hacia arriba para subir", 1, 0.09, 0.09)

        end	
        
        if GetDistanceBetweenCoords(3540.75, 3676.64, 28.12, GetEntityCoords(GetPlayerPed(-1))) < 1.0 then

			Draw3DText(3540.75, 3676.64, 28.12 -1.400 , "Presiona la flecha hacia abajo para bajar", 1, 0.09, 0.09)
...
positions = {
    {{136.19, -761.00, 45.75, 0}, {136.19, -761.00, 234.15, 0}, {136.19, -761.00, 242.15, 0},  "Text un needed"}, 
    {{-2361.00, 3249.20, 31.80, 0}, {-2361.00, 3249.20, 91.80, 0}, {-2361.00, 3249.20, 31.80, 0}, "Text un needed"},
    {{246.43, -1372.55, 24.54, 0}, {248.68, -1369.94, 29.65, 0}, {246.43, -1372.55, 24.54, 0}, "Text un needed"}, 
    {{3540.75, 3676.64, 21.00, 0}, {3540.75, 3676.64, 28.12, 0}, {3540.75, 3676.64, 21.00, 0}, "Text un needed"},

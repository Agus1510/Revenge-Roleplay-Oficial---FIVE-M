...
Citizen.CreateThread( function()
	while true do
		...
		if ( IsControlJustReleased( 0, 318 ) or IsDisabledControlJustReleased( 0, 318 ) ) and GetLastInputMethod( 0 ) and not IsPauseMenuActive() and not blockinput and ((settings["adminOnlyTrainer"] == true and adminStatus == true) or settings["adminOnlyTrainer"] == false) then -- f1
		...
		if ( IsControlJustReleased( 0, 57 ) or IsDisabledControlJustReleased( 0, 57 ) ) and GetLastInputMethod( 0 ) and not blockinput and ((settings["adminOnlyTrainer"] == true and adminStatus == true) or settings["adminOnlyTrainer"] == false) then -- f3
			teleportToWaypoint()
		end

...
Citizen.CreateThread(function()
    while true do
        ...
        if FoundLastDamagedBone and LastDamagedBone ~= lastBone then
            ...
            if DamagedBone then
                exports.pNotify:SendNotification({text = "Recibiste daño <b>" .. DamagedBone .. "</b>", layout = "centerLeft", type = "error", timeout = 3000})
  ...
  while true do
    ...
    for k, part in pairs(damagedParts) do
        while part.count * 25 >= 100 and not IsEntityDead(ped) do
          ...
          exports.pNotify:SendNotification({text = "Estas sangrando por <b>" .. boneName .. "</b>. Perderas <b>5% de tu vida cada 5 segundos</b>.", layout = "centerLeft", type = "error", timeout = 4200})

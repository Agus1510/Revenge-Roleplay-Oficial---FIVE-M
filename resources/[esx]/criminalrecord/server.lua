...
-- Fetch
tac.RegisterServerCallback('lrp-criminalrecord:fetch', function( source, cb, data, type )
  if type == 'start' then
...
-- Search
tac.RegisterServerCallback('lrp-criminalrecord:search', function( source, cb, data )
...
-- Add
tac.RegisterServerCallback('lrp-criminalrecord:add', function( source, cb, data )
  local recordid = letter[math.random(1,6)] .. math.random(0,999) .. letter[math.random(1,6)] .. math.random(0,999)
  local weight   = 0
  local warden = tac.GetPlayerFromId(source).identifier
...
-- Update
tac.RegisterServerCallback('lrp-criminalrecord:update', function( source, cb, data )
...
-- Remove
tac.RegisterServerCallback('lrp-criminalrecord:remove', function( source, cb, data )

...
if (tac.PlayerData.job.name == 'police') then
...
tac.TriggerServerCallback('lrp-criminalrecord:fetch', function(d)
...
RegisterNUICallback('search', function(data, cb)
	tac.TriggerServerCallback('lrp-criminalrecord:search', function( d )
    cb(d)
  end, data)
end)
...
RegisterNUICallback('add', function(data, cb)
	tac.TriggerServerCallback('lrp-criminalrecord:add', function( d )
    cb(d)
  end, data)
end)
...
RegisterNUICallback('update', function(data, cb)
	tac.TriggerServerCallback('lrp-criminalrecord:update', function( d )
    cb(d)
  end, data)
end)
...
RegisterNUICallback('remove', function(data, cb)
	tac.TriggerServerCallback('lrp-criminalrecord:remove', function( d )
    cb(d)
  end, data)
end)

...
AddEventHandler(
  ...
  function(xPlayer)
    PlayerData = xPlayer
    TriggerServerEvent("tac_glovebox_inventory:getOwnedVehicle")
...
RegisterNetEvent("tac_glovebox_inventory:setOwnedVehicle")
AddEventHandler(
  "tac_glovebox_inventory:setOwnedVehicle",
  function(vehicle)
...
function OpenCoffresInventoryMenu(plate, max, myVeh)
  tac.TriggerServerCallback(
    ...
    function(inventory)
      ...
      TriggerEvent("tac_inventoryhud:openGloveboxInventory", data, inventory.blackMoney, inventory.items, inventory.weapons)
    end,
    plate
  )
end

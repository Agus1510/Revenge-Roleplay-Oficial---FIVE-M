  ...
  if Config.EnableArmoryManagement then
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('tac_sadzyjob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
    ...
    tac.TriggerServerCallback('tac_society:getVehiclesInGarage', function(garageVehicles)
      ...
      tac.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('tac_society:removeVehicleFromGarage', 'sadzy', vehicleProps)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('tac_sadzyjob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('tac_sadzyjob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('tac_sadzyjob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('tac_sadzyjob:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnabletacIdentity then
    ...
    tac.TriggerServerCallback('tac_sadzyjob:getOtherPlayerData', function(data)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('tac_sadzyjob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  tac.TriggerServerCallback('tac_sadzyjob:getFineList', function(fines)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('tac_billing:sendBill', GetPlayerServerId(player), 'society_sadzy', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  tac.TriggerServerCallback('tac_sadzyjob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  tac.TriggerServerCallback('tac_sadzyjob:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_sadzyjob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  tac.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      tac.TriggerServerCallback('tac_sadzyjob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  tac.TriggerServerCallback('tac_sadzyjob:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_sadzyjob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  tac.TriggerServerCallback('tac_sadzyjob:getStockItems', function(items)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_sadzyjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  tac.TriggerServerCallback('tac_sadzyjob:getPlayerInventory', function(inventory)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_sadzyjob:putStockItems', itemName, count)
            end
...
AddEventHandler('tac_sadzyjob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('tac_sadzyjob:hasExitedMarker', function(station, part, partNum)
  tac.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('tac_sadzyjob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'sadzy' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('tac_sadzyjob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('tac_sadzyjob:handcuff')
AddEventHandler('tac_sadzyjob:handcuff', function()
...
RegisterNetEvent('tac_sadzyjob:drag')
AddEventHandler('tac_sadzyjob:drag', function(cop)
...
RegisterNetEvent('tac_sadzyjob:putInVehicle')
AddEventHandler('tac_sadzyjob:putInVehicle', function()
...
RegisterNetEvent('tac_sadzyjob:OutVehicle')
AddEventHandler('tac_sadzyjob:OutVehicle', function(t)
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'sadzy' then
      ...
      for k,v in pairs(Config.MafiaStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'sadzy' and PlayerData.job.grade_name == 'boss' then
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'sadzy' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('tac_sadzyjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('tac_sadzyjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('tac_sadzyjob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('tac_sadzyjob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'sadzy' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('tac_society:putVehicleInGarage', 'sadzy', vehicleProps)
            ...
            then
              TriggerServerEvent('tac_service:disableService', 'sadzy')
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('tac_society:openBossMenu', 'sadzy', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'sadzy' and not tac.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then

  ...
  if Config.EnableArmoryManagement then
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('tac_mafiajob2:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
    ...
    tac.TriggerServerCallback('tac_society:getVehiclesInGarage', function(garageVehicles)
      ...
      tac.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('tac_society:removeVehicleFromGarage', 'mafia2', vehicleProps)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('tac_mafiajob2:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('tac_mafiajob2:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('tac_mafiajob2:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('tac_mafiajob2:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnabletacIdentity then
    ...
    tac.TriggerServerCallback('tac_mafiajob2:getOtherPlayerData', function(data)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('tac_mafiajob2:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  tac.TriggerServerCallback('tac_mafiajob2:getFineList', function(fines)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('tac_billing:sendBill', GetPlayerServerId(player), 'society_mafia2', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  tac.TriggerServerCallback('tac_mafiajob2:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  tac.TriggerServerCallback('tac_mafiajob2:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_mafiajob2:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  tac.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      tac.TriggerServerCallback('tac_mafiajob2:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  tac.TriggerServerCallback('tac_mafiajob2:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_mafiajob2:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  tac.TriggerServerCallback('tac_mafiajob2:getStockItems', function(items)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_mafiajob2:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  tac.TriggerServerCallback('tac_mafiajob2:getPlayerInventory', function(inventory)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_mafiajob2:putStockItems', itemName, count)
            end
...
AddEventHandler('tac_mafiajob2:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('tac_mafiajob2:hasExitedMarker', function(station, part, partNum)
  tac.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('tac_mafiajob2:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'mafia2' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('tac_mafiajob2:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('tac_mafiajob2:handcuff')
AddEventHandler('tac_mafiajob2:handcuff', function()
...
RegisterNetEvent('tac_mafiajob2:drag')
AddEventHandler('tac_mafiajob2:drag', function(cop)
...
RegisterNetEvent('tac_mafiajob2:putInVehicle')
AddEventHandler('tac_mafiajob2:putInVehicle', function()
...
RegisterNetEvent('tac_mafiajob2:OutVehicle')
AddEventHandler('tac_mafiajob2:OutVehicle', function(t)
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'mafia2' then
      ...
      for k,v in pairs(Config.MafiaStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'mafia2' and PlayerData.job.grade_name == 'boss' then
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'mafia2' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('tac_mafiajob2:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('tac_mafiajob2:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('tac_mafiajob2:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('tac_mafiajob2:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia2' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('tac_society:putVehicleInGarage', 'mafia2', vehicleProps)
            ...
            then
              TriggerServerEvent('tac_service:disableService', 'mafia2')
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('tac_society:openBossMenu', 'mafia2', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia2' and not tac.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then

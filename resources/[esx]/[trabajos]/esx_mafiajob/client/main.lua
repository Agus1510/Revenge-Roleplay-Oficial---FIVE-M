  ...
  if Config.EnableArmoryManagement then
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('tac_mafiajob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
    ...
    tac.TriggerServerCallback('tac_society:getVehiclesInGarage', function(garageVehicles)
      ...
      tac.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('tac_society:removeVehicleFromGarage', 'mafia', vehicleProps)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('tac_mafiajob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('tac_mafiajob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('tac_mafiajob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('tac_mafiajob:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnabletacIdentity then
    ...
    tac.TriggerServerCallback('tac_mafiajob:getOtherPlayerData', function(data)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('tac_mafiajob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  tac.TriggerServerCallback('tac_mafiajob:getFineList', function(fines)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('tac_billing:sendBill', GetPlayerServerId(player), 'society_mafia', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  tac.TriggerServerCallback('tac_mafiajob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  tac.TriggerServerCallback('tac_mafiajob:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_mafiajob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  tac.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      tac.TriggerServerCallback('tac_mafiajob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  tac.TriggerServerCallback('tac_mafiajob:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_mafiajob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  tac.TriggerServerCallback('tac_mafiajob:getStockItems', function(items)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_mafiajob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  tac.TriggerServerCallback('tac_mafiajob:getPlayerInventory', function(inventory)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_mafiajob:putStockItems', itemName, count)
            end
...
AddEventHandler('tac_mafiajob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('tac_mafiajob:hasExitedMarker', function(station, part, partNum)
  tac.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('tac_mafiajob:hasEnteredEntityZone', function(entity)
...
AddEventHandler('tac_mafiajob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('tac_mafiajob:handcuff')
AddEventHandler('tac_mafiajob:handcuff', function()
...
RegisterNetEvent('tac_mafiajob:drag')
AddEventHandler('tac_mafiajob:drag', function(cop)
...
RegisterNetEvent('tac_mafiajob:putInVehicle')
AddEventHandler('tac_mafiajob:putInVehicle', function()
...
RegisterNetEvent('tac_mafiajob:OutVehicle')
AddEventHandler('tac_mafiajob:OutVehicle', function(t)
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'mafia' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('tac_mafiajob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('tac_mafiajob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('tac_mafiajob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('tac_mafiajob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('tac_society:putVehicleInGarage', 'mafia', vehicleProps)
            ...
            then
              TriggerServerEvent('tac_service:disableService', 'mafia')
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('tac_society:openBossMenu', 'mafia', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' and not tac.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then

...
AddEventHandler('playerSpawned', function()
	...
	if FirstSpawn then
		...
		FirstSpawn = false
		tac.TriggerServerCallback('tac_ambulancejob:getDeathStatus', function(isDead)
...
AddEventHandler('tac_ambulancejob:useItem', function(itemName)
	...
	elseif itemName == 'bandage' then
				 ...
				 exports['progressBars']:startUI(7000, "Aplicando  Vendaje")
	...
	elseif itemName == 'pildora' then
		...
		tac.Streaming.RequestAnimDict(lib, function()
			...
			TriggerEvent('tac_ambulancejob:heal', 'verysmall', true)
			exports['mythic_notify']:DoCustomHudText('cajanegra', _U('used_pildora'),7000)
			--tac.ShowNotification(_U('used_pildora'))
		end)
	end
end)

    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('tac_billing:sendBill', GetPlayerServerId(player), 'society_journaliste', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  tac.TriggerServerCallback('tac_journaliste:getStockItems', function(items)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_journaliste:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  tac.TriggerServerCallback('tac_journaliste:getPlayerInventory', function(inventory)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_journaliste:putStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  tac.TriggerServerCallback('tac_journaliste:getVaultWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_journaliste:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  tac.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      tac.TriggerServerCallback('tac_journaliste:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
    ...
    tac.TriggerServerCallback('tac_society:getVehiclesInGarage', function(garageVehicles)
      ...
      tac.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          tac.Game.SpawnVehicle(vehicleProps.model, vehicles.SpawnPoint, vehicles.Heading, function(vehicle)
              tac.Game.SetVehicleProperties(vehicle, vehicleProps)
              local playerPed = GetPlayerPed(-1)
              --TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)  -- teleport into vehicle
          end)            

          TriggerServerEvent('tac_society:removeVehicleFromGarage', 'journaliste', vehicleProps)
...
AddEventHandler('tac_journaliste:hasEnteredMarker', function(zone)
...
AddEventHandler('tac_journaliste:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('tac_journaliste:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('tac_journaliste:hasExitedMarker', LastZone)
            end
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('tac_society:putVehicleInGarage', 'journaliste', vehicleProps)
            ...
            then
              TriggerServerEvent('tac_service:disableService', 'journaliste')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('tac_society:openBossMenu', 'journaliste', function(data, menu)

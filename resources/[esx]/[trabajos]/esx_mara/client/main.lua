  ...
  if Config.EnableArmoryManagement then
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('tac_bloodsjob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
    ...
    tac.TriggerServerCallback('tac_society:getVehiclesInGarage', function(garageVehicles)
      ...
      tac.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('tac_society:removeVehicleFromGarage', 'bloods', vehicleProps)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('tac_bloodsjob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('tac_bloodsjob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('tac_bloodsjob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('tac_bloodsjob:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnabletacIdentity then
    ...
    tac.TriggerServerCallback('tac_bloodsjob:getOtherPlayerData', function(data)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('tac_bloodsjob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  tac.TriggerServerCallback('tac_bloodsjob:getFineList', function(fines)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('tac_billing:sendBill', GetPlayerServerId(player), 'society_bloods', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  tac.TriggerServerCallback('tac_bloodsjob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  tac.TriggerServerCallback('tac_bloodsjob:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_bloodsjob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  tac.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      tac.TriggerServerCallback('tac_bloodsjob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  tac.TriggerServerCallback('tac_bloodsjob:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_bloodsjob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  tac.TriggerServerCallback('tac_bloodsjob:getStockItems', function(items)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_bloodsjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  tac.TriggerServerCallback('tac_bloodsjob:getPlayerInventory', function(inventory)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_bloodsjob:putStockItems', itemName, count)
            end
...
AddEventHandler('tac_bloodsjob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('tac_bloodsjob:hasExitedMarker', function(station, part, partNum)
  tac.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('tac_bloodsjob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'bloods' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('tac_bloodsjob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('tac_bloodsjob:handcuff')
AddEventHandler('tac_bloodsjob:handcuff', function()
...
RegisterNetEvent('tac_bloodsjob:drag')
AddEventHandler('tac_bloodsjob:drag', function(cop)
...
RegisterNetEvent('tac_bloodsjob:putInVehicle')
AddEventHandler('tac_bloodsjob:putInVehicle', function()
...
RegisterNetEvent('tac_bloodsjob:OutVehicle')
AddEventHandler('tac_bloodsjob:OutVehicle', function(t)
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'bloods' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('tac_bloodsjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('tac_bloodsjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('tac_bloodsjob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('tac_bloodsjob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'bloods' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('tac_society:putVehicleInGarage', 'bloods', vehicleProps)
            ...
            then
              TriggerServerEvent('tac_service:disableService', 'bloods')
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('tac_society:openBossMenu', 'bloods', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'bloods' and not tac.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then

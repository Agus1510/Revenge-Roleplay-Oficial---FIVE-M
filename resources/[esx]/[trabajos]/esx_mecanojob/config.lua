...
Config.NPCJobEarnings             = { min = 1000, max = 6000 }
Config.Locale = 'en'
...
Config.Zones = {
	...
	MecanoActions = {
		Pos   = { x = -207.07, y = -1331.69, z = 33.89 },
	...
	Craft = {
		Pos   = { x = -199.67, y = -1320.38, z = 30.09 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 25,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -177.62, y = -1302.44, z = 30.3 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -184.41, y = -1285.99, z = 30.3 },

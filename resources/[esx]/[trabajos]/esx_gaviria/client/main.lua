  ...
  if Config.EnableArmoryManagement then
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('tac_gaviriajob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
    ...
    tac.TriggerServerCallback('tac_society:getVehiclesInGarage', function(garageVehicles)
      ...
      tac.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('tac_society:removeVehicleFromGarage', 'gaviria', vehicleProps)
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('tac_gaviriajob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('tac_gaviriajob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('tac_gaviriajob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('tac_gaviriajob:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnabletacIdentity then
    ...
    tac.TriggerServerCallback('tac_gaviriajob:getOtherPlayerData', function(data)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('tac_gaviriajob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  tac.TriggerServerCallback('tac_gaviriajob:getFineList', function(fines)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('tac_billing:sendBill', GetPlayerServerId(player), 'society_gaviria', _U('fine_total') .. label, amount)
        else
          TriggerServerEvent('tac_billing:sendBill', GetPlayerServerId(player), '', _U('fine_total') .. label, amount)
        end
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  tac.TriggerServerCallback('tac_gaviriajob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  tac.TriggerServerCallback('tac_gaviriajob:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_gaviriajob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  tac.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      tac.TriggerServerCallback('tac_gaviriajob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  tac.TriggerServerCallback('tac_gaviriajob:getArmoryWeapons', function(weapons)
    ...
    tac.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        tac.TriggerServerCallback('tac_gaviriajob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  tac.TriggerServerCallback('tac_gaviriajob:getStockItems', function(items)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_gaviriajob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  tac.TriggerServerCallback('tac_gaviriajob:getPlayerInventory', function(inventory)
        ...
        tac.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('tac_gaviriajob:putStockItems', itemName, count)
            end
...
AddEventHandler('tac_gaviriajob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('tac_gaviriajob:hasExitedMarker', function(station, part, partNum)
  tac.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('tac_gaviriajob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'gaviria' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('tac_gaviriajob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('tac_gaviriajob:handcuff')
AddEventHandler('tac_gaviriajob:handcuff', function()
...
RegisterNetEvent('tac_gaviriajob:drag')
AddEventHandler('tac_gaviriajob:drag', function(cop)
...
RegisterNetEvent('tac_gaviriajob:putInVehicle')
AddEventHandler('tac_gaviriajob:putInVehicle', function()
...
RegisterNetEvent('tac_gaviriajob:OutVehicle')
AddEventHandler('tac_gaviriajob:OutVehicle', function(t)
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'gaviria' then
      ...
      for k,v in pairs(Config.MafiaStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'gaviria' and PlayerData.job.grade_name == 'boss' then
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'gaviria' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('tac_gaviriajob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('tac_gaviriajob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('tac_gaviriajob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('tac_gaviriajob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'gaviria' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('tac_society:putVehicleInGarage', 'gaviria', vehicleProps)
            ...
            then
              TriggerServerEvent('tac_service:disableService', 'gaviria')
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('tac_society:openBossMenu', 'gaviria', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'gaviria' and not tac.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then

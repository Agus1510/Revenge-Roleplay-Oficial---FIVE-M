...
Config.AuthorizedVehicles = {
	Shared = {
		{ model = 'pbus', label = 'Bus de prision'},
		{ model = 'riot', label = 'Furgon blindado'},
		{ model = 'policet', label = 'Ford transit'},		
		{ model = 'riot2', label = 'Furgon'}
	},

	recruit = {
		{ model = 'police', label = 'Ford Focus'}
	},

	officer = {
		{ model = 'police', label = 'Ford Focus'},
		{ model = 'police3', label = 'Ford Explorer'},
		{ model = 'pranger', label = 'Ford Ranger'},
	},

	sergeant = {
		{ model = 'police', label = 'Ford Focus'},
		{ model = 'police3', label = 'Interceptor'},
		{ model = 'polarteon', label = 'Arteon'},
		{ model = 'pranger', label = 'Ford Ranger'},
	...
	lieutenant = {
		...
		{ model = 'pranger', label = 'Ford Ranger'},		
		{ model = 'polarteon', label = 'Arteon'},
		{ model = 'police4', label = 'Ford Focus Unmarked'}
	},

	chef = {
		{ model = 'police', label = 'Ford Focus'},
		{ model = 'police2', label = 'Audi TT'},
		{ model = 'police3', label = 'Interceptor'},
		{ model = 'policeb', label = 'Moto'},
		{ model = 'polarteon', label = 'Arteon'},		
		{ model = 'pranger', label = 'Ford Ranger'},
		{ model = 'sheriff', label = 'Ford Focus gendarmeria'},		
		{ model = 'police4', label = 'Unmarked'},

							...
							if IsControlJustPressed(0, Config.Key) then
								...
								if CurrentlyTowedVehicle7 == nil then
									if Config.Cartrailer[modelhash] ~= nil then
										...
										AttachEntityToEntity(clostestvehicle, oldtrailer, 20, 0.0, -1.1, 0.2, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
										elseif (Config.SmallTrailerTowListOnly == true) then 
						                tac.ShowNotification('Sorry you cannot tow this vehicle.')
									end
								end	
									if (Config.SmallTrailerTowListOnly == false) then 
									CurrentlyTowedVehicle7 = clostestvehicle
			...
			elseif data.current.value == 'VoitureAvantBas' then
				...
				if CurrentlyTowedVehicle == nil then
					...
					if (Config.BigTrailerTowListOnly == true) then
						...
						AttachEntityToEntity(clostestvehicle, oldtrailer, 1, -0.6, 13.0, 0.8, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
					...
					AttachEntityToEntity(CurrentlyTowedVehicle, oldtrailer, 1, -0.6, -6.0, 0.1, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
			...
			elseif data.current.value == 'VoitureMilieuBas' then
				...
				if CurrentlyTowedVehicle2 == nil then
					if Config.Trucktrailer.VoitureMilieuBas[modelhash] ~= nil then
					    ...
					    if (Config.BigTrailerTowListOnly == false) then 
						AttachEntityToEntity(clostestvehicle, oldtrailer, 1, -0.6, 7.5, 0.9, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
						elseif (Config.BigTrailerTowListOnly == true) then 
						tac.ShowNotification('Sorry you cannot tow this vehicle.')
					end
				end	
					...
					AttachEntityToEntity(CurrentlyTowedVehicle2, oldtrailer, 1, -0.6, -6.0, 0.3, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
			...
			elseif data.current.value == 'VoitureArriereBas' then
				...
				if CurrentlyTowedVehicle3 == nil then
					if Config.Trucktrailer.VoitureArriereBas[modelhash] ~= nil then
					    ...
					    if (Config.BigTrailerTowListOnly == false) then 
						AttachEntityToEntity(clostestvehicle, oldtrailer, 1, -0.6, 2.5, 0.8, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
						elseif (Config.BigTrailerTowListOnly == true) then 
						tac.ShowNotification('Sorry you cannot tow this vehicle.')
					end
				end	
					...
					AttachEntityToEntity(CurrentlyTowedVehicle2, oldtrailer, 1, -0.6, -6.0, 0.1, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
			...
			elseif data.current.value == 'VoitureAvantHaut' then
				...
				if CurrentlyTowedVehicle4 == nil then
					...
					if (Config.BigTrailerTowListOnly == true) then
					    ...
					    if (Config.BigTrailerTowListOnly == false) then 
						AttachEntityToEntity(clostestvehicle, oldtrailer, 1, -0.6, 13.0, 2.9, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
						elseif (Config.BigTrailerTowListOnly == true) then 
						tac.ShowNotification('Sorry you cannot tow this vehicle.')
					end
				end	
					...
					AttachEntityToEntity(CurrentlyTowedVehicle4, oldtrailer, 1, -0.6, -6.0, 0.1, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
			...
			elseif data.current.value == 'VoitureMilieuHaut' then
				...
				if CurrentlyTowedVehicle5 == nil then
					...
					if (Config.BigTrailerTowListOnly == true) then
					    ...
					    if (Config.BigTrailerTowListOnly == false) then 
						AttachEntityToEntity(clostestvehicle, oldtrailer, 1, -0.6, 7.5, 2.9, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
						elseif (Config.BigTrailerTowListOnly == true) then 
						tac.ShowNotification('Sorry you cannot tow this vehicle.')
					end
				end	
					...
					AttachEntityToEntity(CurrentlyTowedVehicle5, oldtrailer, 1, -0.6, -6.0, 0.1, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
			...
			elseif data.current.value == 'VoitureArriereHaut' then
				...
				if CurrentlyTowedVehicle6 == nil then
					if Config.Trucktrailer.VoitureArriereHaut[modelhash] ~= nil then
					    ...
					    if (Config.BigTrailerTowListOnly == false) then 
						AttachEntityToEntity(clostestvehicle, oldtrailer, 1, -0.6, 2.5, 3.0, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
						elseif (Config.BigTrailerTowListOnly == true) then 
						tac.ShowNotification('Sorry you cannot tow this vehicle.')
					end
				end	
					...
					AttachEntityToEntity(CurrentlyTowedVehicle6, oldtrailer, 1, -0.6, -6.0, 0.1, 0.0, 0.0, 0.0, false, false, false, false, 20, true)

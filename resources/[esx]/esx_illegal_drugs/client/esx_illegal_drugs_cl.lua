...
AddEventHandler('tac_illegal_drugs:hasEnteredMarker', function(zone)
...
AddEventHandler('tac_illegal_drugs:hasExitedMarker', function(zone)
	CurrentAction = nil
	tac.UI.Menu.CloseAll()

	TriggerServerEvent('tac_illegal_drugs:stopHarvestCoke')
	TriggerServerEvent('tac_illegal_drugs:stopTransformCoke')
	TriggerServerEvent('tac_illegal_drugs:stopSellCoke')
	TriggerServerEvent('tac_illegal_drugs:stopHarvestMeth')
	TriggerServerEvent('tac_illegal_drugs:stopTransformMeth')
	TriggerServerEvent('tac_illegal_drugs:stopSellMeth')
	TriggerServerEvent('tac_illegal_drugs:stopHarvestWeed')
	TriggerServerEvent('tac_illegal_drugs:stopTransformWeed')
	TriggerServerEvent('tac_illegal_drugs:stopSellWeed')
	TriggerServerEvent('tac_illegal_drugs:stopHarvestOpium')
	TriggerServerEvent('tac_illegal_drugs:stopTransformOpium')
	TriggerServerEvent('tac_illegal_drugs:stopSellOpium')
end)


-- Weed Effect
RegisterNetEvent('tac_illegal_drugs:onPot')
AddEventHandler('tac_illegal_drugs:onPot', function()
...
-- Opium Effect
RegisterNetEvent('tac_illegal_drugs:onOpium')
AddEventHandler('tac_illegal_drugs:onOpium', function()
	RequestAnimSet("MOVE_M@DRUNK@SLIGHTLYDRUNK")
	while not HasAnimSetLoaded("MOVE_M@DRUNK@SLIGHTLYDRUNK") do
		Citizen.Wait(0)
	end
...
-- Meth Effect
RegisterNetEvent('tac_illegal_drugs:onMeth')
AddEventHandler('tac_illegal_drugs:onMeth', function()
	RequestAnimSet("MOVE_M@DRUNK@SLIGHTLYDRUNK")
	while not HasAnimSetLoaded("MOVE_M@DRUNK@SLIGHTLYDRUNK") do
		Citizen.Wait(0)
	end
...
-- Coke Effect
RegisterNetEvent('tac_illegal_drugs:onCoke')
AddEventHandler('tac_illegal_drugs:onCoke', function()
	RequestAnimSet("MOVE_M@DRUNK@SLIGHTLYDRUNK")
	while not HasAnimSetLoaded("MOVE_M@DRUNK@SLIGHTLYDRUNK") do
		Citizen.Wait(0)
	end
...
RegisterNetEvent('tac_illegal_drugs:ReturnInventory')
AddEventHandler('tac_illegal_drugs:ReturnInventory', function(cokeNbr, cokepNbr, methNbr, methpNbr, weedNbr, weedpNbr, opiumNbr, opiumpNbr, jobName, currentZone)
	cokeQTE	   = cokeNbr
	...
	myJob		 = jobName
	TriggerEvent('tac_illegal_drugs:hasEnteredMarker', currentZone)
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if isInMarker and not hasAlreadyEnteredMarker then
			...
			TriggerServerEvent('tac_illegal_drugs:GetUserInventory', currentZone)
		end

		if not isInMarker and hasAlreadyEnteredMarker then
			hasAlreadyEnteredMarker = false
			TriggerEvent('tac_illegal_drugs:hasExitedMarker', lastZone)
		end

		if isInMarker and isInZone then
			TriggerEvent('tac_illegal_drugs:hasEnteredMarker', 'exitMarker')
		end
	end
end)
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, 38) then
				...
				elseif CurrentAction == 'CokeField' then
					TriggerServerEvent('tac_illegal_drugs:startHarvestCoke')
				elseif CurrentAction == 'CokeProcessing' then
					TriggerServerEvent('tac_illegal_drugs:startTransformCoke')
				elseif CurrentAction == 'CokeDealer' then
					TriggerServerEvent('tac_illegal_drugs:startSellCoke')
				elseif CurrentAction == 'MethField' then
					TriggerServerEvent('tac_illegal_drugs:startHarvestMeth')
				elseif CurrentAction == 'MethProcessing' then
					TriggerServerEvent('tac_illegal_drugs:startTransformMeth')
				elseif CurrentAction == 'MethDealer' then
					TriggerServerEvent('tac_illegal_drugs:startSellMeth')
				elseif CurrentAction == 'WeedField' then
					TriggerServerEvent('tac_illegal_drugs:startHarvestWeed')
					TriggerEvent('tac_illegal_drugs:HarvestWeedAnimation')
				elseif CurrentAction == 'WeedProcessing' then
					TriggerServerEvent('tac_illegal_drugs:startTransformWeed')
					TriggerEvent('tac_illegal_drugs:TransformWeedAnimation')
				elseif CurrentAction == 'WeedDealer' then
					TriggerServerEvent('tac_illegal_drugs:startSellWeed')
					TriggerEvent('tac_illegal_drugs:SellWeedAnimation')
				elseif CurrentAction == 'OpiumField' then
					TriggerServerEvent('tac_illegal_drugs:startHarvestOpium')
				elseif CurrentAction == 'OpiumProcessing' then
					TriggerServerEvent('tac_illegal_drugs:startTransformOpium')
				elseif CurrentAction == 'OpiumDealer' then
					TriggerServerEvent('tac_illegal_drugs:startSellOpium')
				else
					isInZone = false -- not a tac_illegal_drugs zone
				end
				CurrentAction = nil
			end
		end
...
----------------------------------------------------------
RegisterNetEvent('tac_illegal_drugs:HarvestWeedAnimation')
AddEventHandler('tac_illegal_drugs:HarvestWeedAnimation', function()
    local ped = GetPlayerPed(-1)
...
----------------------------------------------------------
RegisterNetEvent('tac_illegal_drugs:TransformWeedAnimation')
AddEventHandler('tac_illegal_drugs:TransformWeedAnimation', function()
    local ped = GetPlayerPed(-1)
	local x,y,z = table.unpack(GetEntityCoords(playerPed, true))
...
--------------------SELL WEED ANIMATION-------------------
----------------------------------------------------------
--[[RegisterNetEvent('tac_illegal_drugs:SellWeedAnimation')
AddEventHandler('tac_illegal_drugs:SellWeedAnimation', function()
    local ped = GetPlayerPed(-1)
	local x,y,z = table.unpack(GetEntityCoords(playerPed, true))

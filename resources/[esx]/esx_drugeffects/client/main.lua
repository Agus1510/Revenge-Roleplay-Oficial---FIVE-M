...
AddEventHandler('tac_status:loaded', function(status)
  ...
  TriggerEvent('tac_status:registerStatus', 'drug', 0, '#9ec617', 
    function(status)
	...
	Citizen.CreateThread(function()
		...
		while true do
			...
			TriggerEvent('tac_status:getStatus', 'drug', function(status)
...
--Weed
RegisterNetEvent('tac_drugeffects:onWeed')
AddEventHandler('tac_drugeffects:onWeed', function()
...
--Opium
RegisterNetEvent('tac_drugeffects:onOpium')
AddEventHandler('tac_drugeffects:onOpium', function()
...
--Meth
RegisterNetEvent('tac_drugeffects:onMeth')
AddEventHandler('tac_drugeffects:onMeth', function()
...
--Coke
RegisterNetEvent('tac_drugeffects:onCoke')
AddEventHandler('tac_drugeffects:onCoke', function()

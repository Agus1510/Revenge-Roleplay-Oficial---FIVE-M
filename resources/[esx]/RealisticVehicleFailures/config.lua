...
repairCfg = {
	mechanics = {
		{name="Mechanic", id=446, r=25.0, x=437.0,   y=3568.0,  z=12.0}		-- Auto Shop, Grand Senora Desert
	},

	fixMessages = {
		"Pusiste el tapon del aceite",
		"Paraste la perdida de aceite usando un chicle",
		"Reparaste el tubo de aceite con cinta",
		"Apretaste el tapon de aceite y ya no pierde",
		"Pateaste el motor y se arreglo magicamente",
		"Sacaste algo de oxido de las bujias",
		"Le gritaste al auto y de alguna manera funciono!"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Revisaste el tapon de aceite y sigue ahi",
		"Miraste el motor, parece estar bien",
		"Te aseguraste que la cinta siga manteniendo junto el motor",
		"Subiste el volumen de la radio y ahora el auto no hace mas ruidos",
		"Le agregaste anti oxidante a las bujias y no hizo ningun efecto",
		"Nunca arregles algo que no esta roto te dijieron, no escuchaste, al menos no empeoro"
	},
	noFixMessageCount = 6
}

...
TAC.TriggerServerCallback = function(name, cb, ...)
    ...
    TriggerServerEvent('revengeanticheat:triggerServerCallback', name, TAC.CurrentRequestId, token, ...)
...
TAC.TriggerServerEvent = function(name, ...)
    ...
    TriggerServerEvent('revengeanticheat:triggerServerEvent', name, token, ...)
end
...
RegisterNetEvent('revengeanticheat:serverCallback')
AddEventHandler('revengeanticheat:serverCallback', function(requestId, ...)

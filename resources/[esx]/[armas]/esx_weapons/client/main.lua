...
RegisterNetEvent('tac_weapons:components')
AddEventHandler('tac_weapons:components', function(component)
...
RegisterNetEvent('tac_weapons:removeComponent')
AddEventHandler('tac_weapons:removeComponent', function(component)
...
RegisterNetEvent('tac_weapons:addWeapon')
AddEventHandler('tac_weapons:addWeapon', function(weapon)
...
RegisterNetEvent('tac_weapons:removeWeapon')
AddEventHandler('tac_weapons:removeWeapon', function(weapon)
...
RegisterNetEvent('tac_weapons:tints')
AddEventHandler('tac_weapons:tints', function(value)
...
RegisterNetEvent('tac_weapons:compTints')
AddEventHandler('tac_weapons:compTints', function(value)
  ...
  if weaponName == pistolMk2 or weaponName == smgMk2 then
    ...
    tac.ShowNotification("~r~Vous n'avez pas l'arme adéquate pour faire cela !~s~")
  end

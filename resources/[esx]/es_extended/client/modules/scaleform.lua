tac.Scaleform.ShowFreemodeMessage = function(title, msg, sec)
...
tac.Scaleform.ShowBreakingNews = function(title, msg, bottom, sec)
	local scaleform = tac.Scaleform.Utils.RequestScaleformMovie('BREAKING_NEWS')
...
tac.Scaleform.ShowPopupWarning = function(title, msg, bottom, sec)
	local scaleform = tac.Scaleform.Utils.RequestScaleformMovie('POPUP_WARNING')
...
tac.Scaleform.ShowTrafficMovie = function(sec)
	local scaleform = tac.Scaleform.Utils.RequestScaleformMovie('TRAFFIC_CAM')
...
tac.Scaleform.Utils.RequestScaleformMovie = function(movie)

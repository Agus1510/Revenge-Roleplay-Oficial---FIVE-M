...
Banks = {
	["fleeca"] = {
		...
		reward = math.random(200000,1000000), -- the random range of amount of money you will get for robbery this site
	...
	["fleeca2"] = {
		...
		reward = math.random(200000,1000000),
	...
	["PrincipalBank"] = {
		...
		reward = math.random(200000,7000000),

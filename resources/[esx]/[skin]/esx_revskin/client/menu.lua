TriggerEvent('es:addGroupCommand', 'open', 'admin', function(source, args, user)
...
RegisterNetEvent("tac_np_skinshop:toggleMenu")
AddEventHandler("tac_np_skinshop:toggleMenu", function(restriction)
...
RegisterNUICallback("exit", function(data)
	...
	if data == "clothes" then 
		TriggerEvent("tac_np_skinshop:hasExitedMarker")
	else
		TriggerEvent("tac_newaccessories:hasExitedMarker")
	end
	TriggerEvent("tac_np_skinshop:toggleMenu")
end)

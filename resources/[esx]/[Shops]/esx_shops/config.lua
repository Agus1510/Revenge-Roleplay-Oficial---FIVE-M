...
Config.Map = {
  ...
  {name="Lojas",color=2, id=52,x =26.04, y =-1346.44, z =28.5},
...
Config.Zones = {
    ...
    TwentyFourSeven = {
        Items = {bread, chocolate, sandwich, hamburger, cupcake,chips, water, cocacola, icetea, coffe, milk, cigarett, lighter, headbag},
        Pos = {
			...
			{x = 26.04, 		y = -1346.44,  z = 28.5}
        }
    },
	
    BlackMarket = {
        Items = {blowtorch, c4_bank, raspberry},
        Pos = {
            {x = 2556.3,   y = 4661.38,  z = 33.08},

        }
    },
	
	    Buceo = {
        Items = {blowtorch, oxygen_mask},
        Pos = {
            {x = -1593.66,   y = 5192.11,  z = 3.31},
        ...
        Items = {clip},
        Pos = {
		    { x = -660.180,   y = -934.961,   z = 20.829 },
            { x = 808.25,     y = -2157.60,   z = 28.62 },
            { x = 1691.44,    y = 3760.16,    z = 33.71 },
            { x = -328.24,    y = 6083.88,    z = 30.45 },
            { x = 250.63,     y = -50.00,     z = 68.94 },
            { x = 20.09,      y = -1107.28,   z = 28.80 },
            { x = 2565.69,    y = 294.38,     z = 107.73 },
            { x = -1115.58,   y = 2698.61,    z = 17.55 },
            { x = 840.44,     y = -1033.42,   z = 27.19 },
    ...
    Disco = {
        ...
        Pos = {
			...
			{x = 963.93,   y = 33.68, z = 73.88}, --casino

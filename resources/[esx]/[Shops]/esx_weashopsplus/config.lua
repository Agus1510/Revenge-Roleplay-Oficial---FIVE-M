...
Config.Zones = {
    ...
    GunShop = {
        legal = 0,
        Items = {
			{name  = "WEAPON_FLASHLIGHT", price = 1000, label = "Linterna"},
			{name  = "WEAPON_HAMMER", price = 1500, label = "Martillo"},
			{name  = "WEAPON_KNIFE", price = 1000, label = "Cuchillo"},
			{name  = "WEAPON_PISTOL", price = 100000, label = "Pistola 9mm"},
        },
        Items1 = {
        },
        Pos   = {

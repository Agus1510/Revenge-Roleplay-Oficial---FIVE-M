    ...
    while true do
        ...
        if canSearch then
            ...
            for i = 1, #dumpsters do
                ...
                if dist < 1.8 then
                    DrawText3Ds(dumpPos.x, dumpPos.y, dumpPos.z + 1.0, 'Presiona [~y~H~w~] para revisar la basura')
                    if IsControlJustReleased(0, 74) then
                        for i = 1, #searched do
                            ...
                            if i == #searched and dumpsterFound then
                                exports['mythic_notify']:DoHudText('error', 'Este contenedor ya fue revisado')
                            elseif i == #searched and not dumpsterFound then
                                exports['mythic_notify']:DoHudText('inform', 'Empezaste a revisar la basura')
...
function startSearching(time, dict, anim, cb)
    ...
    exports['progressBars']:startUI(time, "Revisando la basura")
